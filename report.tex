...
The main category that helped with family pressure was health care (e.g. hydration, exercise, etc) while the main one that helped with procrastination was self-control (e.g. scheduling, prioritizing, etc). Students who tried to deal with procrastination with a strategy of family pressure or vice versa had higher anxiety.
