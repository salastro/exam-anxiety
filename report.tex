...
\begin{abstract}
    ...
    students. The model concluded that procrastination has more effect than
...
The problem in hand is hard to solve. However, it is possible to reach
reasonable conclusions from the data and answers. The most notable pattern in
less anxious students is there awareness of the most prominent factor affecting
them. They know what the problem is then solve it. Each aware student had their
own technique for dealing with their anxiety. The techniques are not the same
yet they fall in similar categories.
...
The solution proposed based on the data is to a multi-step system that is most
concerned with the identification of the type of anxiety, then applying a number
