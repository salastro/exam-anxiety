...
\begin{abstract}
    ...
    pressure. This report presents the qualitative effects of the two in order
    to form more sophisticated plans for dealing with the educational issues
    that arise. The method by which these factors are compared is based on a
